    ...
    public interface ITrigger
    {
        ...
        public static ITrigger? GetTrigger(string? name)
        {
            ...
            return name switch
            {
                ...
                string prehit when prehit.Contains("prehit") => new DamageTypeTrigger<WeaponPreHitDamageableContext>(TriggerName.PreHit, name.ToDamageType()),
                string hit when hit.Contains("hit") => new DamageTypeTrigger<WeaponHitDamageableContext>(TriggerName.Hit, name.ToDamageType()),
